...
%%% Commande pour compiler: xelatex main.tex
...
%%% Décommenter ces lignes et commenter les 3 du dessus pour faire l'export vers html 
%%% Commande: htlatex main.tex -> plein d'erreurs, faire Control+D pour les passer, l'export
...
\setcounter{page}{1}
%%% Style de des headers de chaque page
